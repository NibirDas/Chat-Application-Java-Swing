...
public class Client implements ActionListener {
    ...
    Client() {
        ...
        tele.setBounds(360, 20, 35, 30);
        p1.add(tele);

        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("icons/3icon.png"));
        Image i14 = i13.getImage().getScaledInstance(10, 25, Image.SCALE_DEFAULT);
        ImageIcon i15 = new ImageIcon(i14);
        JLabel volley = new JLabel(i15);
        volley.setBounds(420, 20, 10, 25);
        p1.add(volley);

        JLabel name = new JLabel("Banner");
        ...
        text1.setFont(new Font("SANS_SARIF", Font.BOLD, 18));
        f.add(text1);
        ...
        send.setFont(new Font("SANS_SARIF", Font.BOLD, 18));
        f.add(send);
